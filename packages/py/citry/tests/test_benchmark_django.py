...
# tests/test_benchmark_django.py at commit
...
# Adapted: upstream snapshots the output. This page is non-deterministic
# (naturaltime is relative to now, the CSRF token is random), so this is a
# structural smoke test instead: it guards that the benchmarked logic still
